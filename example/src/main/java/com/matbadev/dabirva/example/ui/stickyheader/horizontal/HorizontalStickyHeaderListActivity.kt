...
class HorizontalStickyHeaderListActivity :
    BaseActivity<HorizontalStickyHeaderListEvent, HorizontalStickyHeaderListArguments, HorizontalStickyHeaderListViewModel>(
